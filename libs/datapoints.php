...
$DP = array(
    ...
    array('metric/m/monotonic','Uptime in seconds', 'INT', '~UnixTimestamp'),
    ...
    array('metric/m/net/mdm/sq','…and signal quality', 'INT', 'OVMS_dBm'),
    array('metric/m/net/provider','Current primary network provider', 'STRING', ''),
    array('metric/m/net/sq','…signal quality', 'INT', 'OVMS_dBm'),
    array('metric/m/net/type','…and type (none/modem/wifi)', 'STRING', ''),
    array('metric/m/net/wifi/network','Current Wifi network SSID', 'STRING', ''),
    array('metric/m/net/wifi/sq','…and signal quality', 'INT', 'OVMS_dBm'),
    ...
    array('metric/v/c/duration/range','… for sufficient range', 'INT', ''),
    array('metric/v/c/duration/soc','… for sufficient SOC', 'INT', ''),
    ...
    array('metric/v/c/timerstart','Time timer is due to start, seconds since midnight UTC', 'INT', ''),
    ...
    array('metric/v/e/drivetime','Seconds driving (turned on)', 'FLOAT', ''),
    ...
    array('metric/v/e/parktime','Seconds parking (turned off)', 'INT', '~UnixTimestamp'),
    ...
    array('metric/v/e/serv/time','Time of next scheduled maintenance/service [Seconds]', 'INT', 'OVMS_KM'),
    ...
    array('metric/v/g/duration/range','… for range limit', 'INT', ''),
    array('metric/v/g/duration/soc','… for SOC limit', 'INT', ''),
    ...
    array('metric/v/g/timerstart','Time generator is due to start', 'INT', ''),
    ...
    array('metric/v/p/gpstime','Time (UTC) of GPS coordinates [Seconds]', 'INT', '~UnixTimestamp'),
