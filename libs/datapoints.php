...
$DP = array(
    ...
    array('metric/m/net/mdm/mode','Current GSM mode', 'STRING', ''),
    array('metric/m/net/mdm/netreg','Current registration', 'STRING', ''),
    ...
    array('metric/v/b/c/temp/alert','Cell temperature deviation alert level', 'INT', 'OVMS_Alarm'),
    ...
    array('metric/v/b/c/voltage/alert','Cell voltage deviation alert level', 'INT', 'OVMS_Alarm'),
    ...
    array('metric/v/e/gear','gear mode', 'STRING', ''),
    ...
    array('metric/v/p/valet/latitude','GPS latitude', 'FLOAT', ''),
    array('metric/v/p/valet/longitude','GPS longitude', 'FLOAT', ''),
    array('metric/v/t/alert','TPMS tyre alert levels', 'INT', ''),
